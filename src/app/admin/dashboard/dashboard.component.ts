...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ProjectCost = 23323;
    this.CurrentExpenditure = 23232;
    this.AvailableFunds = 434342;
  ...
  onYearChange($event) {
    document.getElementById('dropDownMenuButton1').innerHTML = $event.target.innerHTML;

  }

  onProjectChange($event) {

    document.getElementById('dropDownMenuButton').innerHTML = $event.target.innerHTML;
